  ...
  return (
    <form className="flex flex-col w-full items-start gap-2">
      <div>
        ...
        <div className="flex gap-2">
          <label htmlFor="image1">
            <img className="w-20" src={assets.upload_area} alt="Uplad Icon"/>
      ...
      <div className="w-full">
        ...
        <textarea className="w-full max-w-125 px-3 py-2" type="text" placeholder="Write Here" required/>
      </div>
      ...
      <div className="flex flex-col sm:flex-row gap-2 w-full sm:gap-8">
        ...
        <div>
          ...
          <input className="w-full px-3 py-3 sm:w-30" type="Number" placeholder="25"/>
        </div>
      </div>
      <div>
