    ...
    <div className="m-10">
      <div className="text-center text-3xl py-8">
        ...
        <p className="w-3/4 m-auto text-x5 sm:text-sm md:text-base text-gray-600">
          ...
          repudiandae exercitationem architecto earum sapiente obcaecati porro,
          nulla omnis tempore, provident optio ullam adipisci neque id esse,
          nisi dignissimos? Tenetur?
        </p>
      </div>
